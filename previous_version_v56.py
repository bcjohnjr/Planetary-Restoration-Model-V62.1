...
V53_JSON = HERE / "planetary_restoration_v53_1_results.json"
FAIR_ZIP = HERE / "fair-v2.2.4-results.zip"
HECTOR_ZIP = HERE / "hector-v3.5.0-results.zip"
TRAJECTORY = HERE / "external_validation_net_co2_trajectory.csv"
